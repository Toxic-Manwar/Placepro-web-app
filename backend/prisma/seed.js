...
async function main() {
    ...
    const initialStudentSkills = [
        { name: 'React', proficiency: 82, tier: 'ASSESSMENT_VERIFIED' },
        { name: 'JavaScript', proficiency: 78, tier: 'ASSESSMENT_VERIFIED' },
        { name: 'Node.js', proficiency: 55, tier: 'SELF_REPORTED' },
        { name: 'SQL', proficiency: 48, tier: 'SELF_REPORTED' },
        { name: 'Cloud', proficiency: 28, tier: 'SELF_REPORTED' },
        { name: 'Docker', proficiency: 25, tier: 'SELF_REPORTED' },
        { name: 'Python', proficiency: 75, tier: 'ASSESSMENT_VERIFIED' },
        { name: 'Communication', proficiency: 85, tier: 'ASSESSMENT_VERIFIED' },
        { name: 'Problem-Solving', proficiency: 80, tier: 'ASSESSMENT_VERIFIED' }
    ];
    ...
    // 7. Create Diagnostic Assessment & Questions
